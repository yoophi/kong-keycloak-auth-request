...
function _M.execute(conf)
    ...
    local roles = table.concat(response_json['realm_access']['roles'], ",")
    kong.service.request.set_header('roles', roles)
end
...
function _M.new_auth_request(host, port, path, client_id, client_secret, token, keepalive_timeout)
    local hostname = host
